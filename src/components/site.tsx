  ...
  return (
    <footer className="relative isolate overflow-hidden text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-6 pt-14 md:px-8 md:pb-8 md:pt-20">
          ...
          <div className="mt-6 border-t border-white/10 pt-6">
            ...
            <div className="grid gap-5 md:grid-cols-2 md:gap-6">
              {[
                ...
                <div key={loc.query}>
                  <p className="text-sm text-white/85">{loc.line1}</p>
                  <p className="text-sm text-white/85">{loc.line2}</p>
                  <a
        ...
        <div className="grid gap-10 border-t border-white/15 pt-10 sm:grid-cols-2 lg:grid-cols-[1.15fr_1fr_1fr_1fr] lg:items-start lg:gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="relative aspect-square max-w-[22rem] overflow-hidden rounded-[1.5rem] border border-white/15 shadow-2xl shadow-black/30 sm:rounded-[1.75rem]">
              <Image
                src={FOOTER_PART_SRC}
                alt="DTdogs.ca care team with happy dogs"
                fill
